...
import { MEETING_SCHEDULE_STATUSES } from '../api/types';
...
export const meetingScheduleSchema = z.object({
  ...
  status: z.enum(MEETING_SCHEDULE_STATUSES)
});

export type MeetingScheduleFormSchemaValues = z.infer<typeof meetingScheduleSchema>;
